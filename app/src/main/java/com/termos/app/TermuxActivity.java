...
import com.termos.R;
import com.termos.app.api.file.FileReceiverActivity;
import com.termos.app.activities.RootfsSetupActivity;
...
import com.termos.app.activities.HelpActivity;
import com.termos.app.activities.SettingsActivity;
import com.termux.shared.termux.crash.TermuxCrashUtils;
import com.termux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.termos.app.terminal.TermuxSessionsListViewController;
import com.termos.app.terminal.io.TerminalToolbarViewPager;
...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Check if rootfs is installed, show setup if not
        RootfsManager rootfsManager = new RootfsManager(this);
        if (!rootfsManager.isRootfsInstalled()) {
            Intent setupIntent = new Intent(this, RootfsSetupActivity.class);
        ...
        // Context menu registration will happen when TerminalView is ready (from TerminalTabFragment)
    ...
    private void setTermuxTerminalViewAndClients() {
        ...
        // TerminalView will be set from TerminalTabFragment via onTerminalViewReady()
        // Initialize clients now, TerminalView will be set later
        if (mTermuxTerminalViewClient != null)
    ...
    /**
     * Called by TerminalTabFragment when TerminalView is ready
     */
    public void onTerminalViewReady(TerminalView terminalView) {
    ...
    /**
     * Get the TermuxService instance.
     * Used by fragments to access service for command execution.
     */
