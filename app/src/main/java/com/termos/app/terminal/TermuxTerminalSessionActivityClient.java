package com.termos.app.terminal;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    public void onTextChanged(@NonNull TerminalSession changedSession) {
        ...
        if (mActivity.getCurrentSession() == changedSession && mActivity.getTerminalView() != null)
            mActivity.getTerminalView().onScreenUpdated();
    }
    ...
    public void onPasteTextFromClipboard(@Nullable TerminalSession session) {
        ...
        if (text != null && mActivity.getTerminalView() != null)
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                // Bell sound resource not available - bell functionality disabled
                // mBellSoundId = mBellSoundPool.load(mActivity, R.raw.bell, 1);
                mBellSoundId = 0; // No bell sound
            } catch (Exception e){
                ...
                mBellSoundId = 0; // No bell sound on error
            }
        }
    }
    ...
    public void setCurrentSession(TerminalSession session) {
        ...
        if (mActivity.getTerminalView() != null && mActivity.getTerminalView().attachSession(session)) {
